...
<main>
  <div id="pageHead">
    <h1><span class="material-icons">event_note</span>見積管理</h1>
    @can('create', App\Models\Reserve::class)
      <div class="rtBtn">
        <button onclick="location.href='{{ route('staff.asp.estimates.normal.create', $agencyAccount) }}'" class="addBtn"><span class="material-icons">event_available</span>新規見積</button>
      </div>
    @endcan
    <form method="GET" action="{{ route('staff.asp.estimates.normal.index', [$agencyAccount]) }}">
      <div id="searchBox">
        <div id="inputList">
          <ul class="sideList">
            <li class="wd20"><span class="inputLabel">見積番号</span>
              <input type="text" name="estimate_number" value="{{ $searchParam['estimate_number'] }}">
            </li>
  ...
  <div id="estimateList" class="tableWrap dragTable" 
...
<script src="{{ mix('/staff/js/estimate-index.js') }}"></script>
@endsection
