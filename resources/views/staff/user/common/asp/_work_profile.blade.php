...
<div class="inputSubArea">
  <ul class="baseList">
    <li class="wd50">
      ...
      <input type="text" name="userable[workspace_name]" value="{{ $defaultValue['userable']['workspace_name'] ?? null }}" maxlength="32">
    </li>
    <li class="wd100">
      <span class="inputLabel">住所</span>
      <input type="text" name="userable[workspace_address]" value="{{ $defaultValue['userable']['workspace_address'] ?? null }}" maxlength="100">
    </li>
    <li class="wd50">
      <span class="inputLabel">電話番号</span>
      <input type="tel" name="userable[workspace_tel]" value="{{ $defaultValue['userable']['workspace_tel'] ?? null }}" maxlength="32">
    </li>
    ...
    <li class="wd100">
      ...
      <textarea rows="3" name="userable[workspace_note]">{{ $defaultValue['userable']['workspace_note'] ?? null }}</textarea>
    </li>
  </ul>
</div>