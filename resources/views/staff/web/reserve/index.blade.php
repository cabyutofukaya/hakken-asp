...
<main>
  <div id="pageHead">
    <h1>
      <span class="material-icons">event_note</span>WEB予約管理
    </h1>
    <form method="GET" action="{{ route('staff.web.estimates.reserve.index', [$agencyAccount]) }}">
      <div id="searchBox">
        <div id="inputList">
          <ul class="sideList">
            <li class="wd20">
...
<script src="{{ mix('/staff/js/web-reserve-index.js') }}"></script>
@endsection
