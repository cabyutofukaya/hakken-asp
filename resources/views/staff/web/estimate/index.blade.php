...
<main>
  <div id="pageHead">
    <h1><span class="material-icons">event_note</span>WEB見積管理</h1>
    <form method="GET" action="{{ route('staff.web.estimates.normal.index', [$agencyAccount]) }}">
      <div id="searchBox">
        <div id="inputList">
          <ul class="sideList">
            <li class="wd20"><span class="inputLabel">見積/依頼番号</span>
...
<div id="onlineRequestModal"><!-- モーダル表示エリア --></div>
...
<script src="{{ mix('/staff/js/web-estimate-index.js') }}"></script>
@endsection
