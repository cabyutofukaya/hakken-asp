 ...
 * @returns
 */
const ParticipantCancelChargeModal = ({
    id,
    defaultCheck,
    nonChargeAction,
    chargeAction,
            ...
            <div className="modal__content">
                ...
                <ul className="sideList baseRadio mb20 central">
                    <li>
                        <input
                            type="radio"
                            name="participant_cancel_charge"
                            id={`${id}_participant_charge_n`}
                            value={RESERVE.CANCEL_CHARGE_NO}
                            onChange={handleChange}
                            checked={value == RESERVE.CANCEL_CHARGE_NO}
                        />
                        <label htmlFor={`${id}_participant_charge_n`}>
                            キャンセルチャージなし
                        </label>
                    </li>
                    <li>
...
export default ParticipantCancelChargeModal;
