        ...
        <>
            <div className="modal__content">
                ...
                <ul className="sideList half">
                    ...
                    {/* <li>
                        <span className="inputLabel">区分</span>
                        <div className="selectBox">
                            <select>
                                <option value="国内パッケージツアー">
                                    国内パッケージツアー
                                </option>
                                <option value="手数料">手数料</option>
                                <option value="その他">その他</option>
                                <option value="JR乗車券">JR乗車券</option>
                                <option value="高速代金">高速代金</option>
                                <option value="貸切バス">貸切バス</option>
                                <option value="観覧料">観覧料</option>
                                <option value="保険">保険</option>
                                <option value="お食事代">お食事代</option>
                                <option value="食事代(お弁当)">
                                    食事代(お弁当)
                                </option>
                                <option value="TAX・燃油">TAX・燃油</option>
                                <option value="運賃">運賃</option>
                                <option value="わんこそば">わんこそば</option>
                                <option value="ゴルフ代金">ゴルフ代金</option>
                                <option value="現地オプション">
                                    現地オプション
                                </option>
                                <option value="旅行代金">旅行代金</option>
                                <option value="諸税">諸税</option>
                                <option value="レンタカー">レンタカー</option>
                                <option value="ホテルオプション">
                                    ホテルオプション
                                </option>
                            </select>
                        </div>
