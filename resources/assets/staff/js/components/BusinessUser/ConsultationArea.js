...
const ConsultationArea = ({
    ...
    const fetch = async () => {
        ...
        const response = await axios
            .get(
                `/api/${agencyAccount}/client/business/${userNumber}/consultation/list`,
                {
                    params: {
                        page: page,
                        sort: sort,
    ...
    const handleSubmit = async e => {
        ...
        if (editMode === "create") {
            ...
            response = await axios
                .post(
                    `/api/${agencyAccount}/client/business/${userNumber}/consultation`,
                    {
                        ...input
                    }
                )
            ...
            response = await axios
                .post(
                    `/api/${agencyAccount}/client/business/${userNumber}/consultation/${input.control_number}`,
                    {
                        ...input,
                        _method: "put"
                    }
