...
const HistoryArea = ({ isShow, userNumber, consts, permission }) => {
    ...
    const fetch = async () => {
        ...
        const response = await axios
            .get(
                `/api/${agencyAccount}/client/person/${userNumber}/usage_history/list`,
                {
                    params: {
                        page: page,
                        sort: sort,
    ...
    const handleCreateButton = e => {
        e.preventDefault();
        location.href =
            consts.estimateNormalCreateUrl + `?user_number=${userNumber}`;
    };
        ...
        >
            ...
            {permission?.create && (
                <ul className="clientContNav">
                    <li>
                        <button className="addBtn" onClick={handleCreateButton}>
