...
class CreateReservePurchasingSubjectAirplanesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('reserve_purchasing_subject_airplanes', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('reserve_purchasing_subject_airplanes');
    }
}
