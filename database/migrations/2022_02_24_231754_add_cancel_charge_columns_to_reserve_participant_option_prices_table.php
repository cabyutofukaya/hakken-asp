...
class AddCancelChargeColumnsToReserveParticipantOptionPricesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::table('reserve_participant_option_prices', function (Blueprint $table) {
            $table->dropForeign('reserve_participant_option_prices_reserve_id_foreign');
