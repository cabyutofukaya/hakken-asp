...
class CreateWebProfileProfilePhotosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('web_profile_profile_photos', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('web_profile_profile_photos');
    }
}
