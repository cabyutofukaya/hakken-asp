...
class CreateReserveParticipantAirplanePricesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('reserve_participant_airplane_prices', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedBigInteger('reserve_itinerary_id')->comment('行程ID');
            $table->unsignedBigInteger('reserve_purchasing_subject_airplane_id')->comment('航空券科目ID');
            ...
            $table->string('seat', 100)->nullable()->comment('座席');
            $table->string('reference_number', 100)->nullable()->comment('REF番号');
            ...
            $table->foreign('reserve_purchasing_subject_airplane_id')
                ...
                ->onDelete('cascade')->name('reserve_purchasing_subject_airplane_foreign');
    ...
    {
        Schema::dropIfExists('reserve_participant_airplane_prices');
    }
}
