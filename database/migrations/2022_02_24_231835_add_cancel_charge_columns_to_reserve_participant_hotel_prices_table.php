...
class AddCancelChargeColumnsToReserveParticipantHotelPricesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::table('reserve_participant_hotel_prices', function (Blueprint $table) {
            $table->dropForeign('reserve_participant_hotel_prices_reserve_id_foreign');
