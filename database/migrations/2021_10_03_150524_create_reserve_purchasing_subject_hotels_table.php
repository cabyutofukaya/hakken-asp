...
class CreateReservePurchasingSubjectHotelsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('reserve_purchasing_subject_hotels', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('reserve_purchasing_subject_hotels');
    }
}
