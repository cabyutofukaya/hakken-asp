...
class Staff extends Authenticatable implements AppUser
{
    ...
    public function getIsManagementSettingReadPermissionAttribute() : bool
    {
        ...
        return in_array(
            config('consts.agency_roles.READ'),
            data_get($this->agency_role->authority, config('consts.agency_roles.ACCOUNT_PAYABLE_DETAILS|ACCOUNT_PAYABLES|AGENCY_BUNDLE_DEPOSITS|AGENCY_DEPOSITS|AGENCY_WITHDRAWALS|RESERVE_BUNDLE_INVOICES|RESERVE_BUNDLE_RECEIPTS|RESERVE_INVOICES|RESERVE_RECEIPTS|V_RESERVE_INVOICES'), [])
        );
    }
