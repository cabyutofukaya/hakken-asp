...
{
    public function __construct(ReserveItineraryService $reserveItineraryService, ReserveConfirmService $reserveConfirmService, WebEstimateService $webEstimateService, WebReserveService $webReserveService)
    {
    ...
    public function create(string $agencyAccount, string $applicationStep, string $controlNumber, string $itineraryNumber)
    {
        ...
        // viewはeditと共通
        return view('staff.web.reserve_confirm.edit', compact('reserve', 'reserveItinerary', 'estimateNumber', 'reserveNumber', 'itineraryNumber', 'applicationStep'));
    }
    ...
    public function edit(string $agencyAccount, string $applicationStep, string $controlNumber, string $itineraryNumber, string $confirmNumber)
    {
        ...
        return view('staff.web.reserve_confirm.edit', compact('reserve', 'reserveConfirm', 'estimateNumber', 'reserveNumber', 'itineraryNumber', 'confirmNumber', 'applicationStep', 'reserveItinerary'));
    }
