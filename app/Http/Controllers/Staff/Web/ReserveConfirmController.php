...
class ReserveConfirmController extends AppController
{
    ...
    public function create(string $agencyAccount, string $applicationStep, string $controlNumber, string $itineraryNumber)
    {
        ...
        // viewはeditと共通
        return view('staff.web.reserve_confirm.edit', compact('reserveItinerary', 'estimateNumber', 'reserveNumber', 'itineraryNumber', 'applicationStep'));
    }
    ...
    public function edit(string $agencyAccount, string $applicationStep, string $controlNumber, string $itineraryNumber, string $confirmNumber)
    {
        ...
        return view('staff.web.reserve_confirm.edit', compact('reserveConfirm', 'estimateNumber', 'reserveNumber', 'itineraryNumber', 'confirmNumber', 'applicationStep', 'reserveItinerary'));
    }
