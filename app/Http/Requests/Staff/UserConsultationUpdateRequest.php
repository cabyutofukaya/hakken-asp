...
use App\Rules\ExistUserNumber;
use App\Services\StaffService;
use Hashids;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Validation\Rule;

class UserConsultationUpdateRequest extends FormRequest
{
    ...
    public function validationData()
    {
        return array_merge($this->request->all(), [
            ...
            'consultation_number' => $this->consultationNumber,
        ]);
    }
    ...
    {
        return [
            'user_number' => ['required',new ExistUserNumber(auth('staff')->user()->agency->id)],
            'consultation_number' => 'required',
    ...
    public function messages()
    {
        return [
            ...
            'consultation_number.required' => '相談番号は必須です。',
