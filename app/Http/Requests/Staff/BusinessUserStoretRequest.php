...
class BusinessUserStoretRequest extends FormRequest
{
    public function __construct(StaffService $staffService, PrefectureService $prefectureService)
    {
    ...
    public function messages()
    {
        return [
            ...
            'business_user_managers.*.name_roman.max' => '担当者ローマ字(取引先担当者情報)が長すぎます(100文字まで)。',
