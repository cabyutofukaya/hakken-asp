<?php
namespace App\Http\ViewComposers\Staff\UserCustomItem\Date;
...
/**
 * カスタム項目（日時用）作成フォームに使う選択項目などを提供するViewComposer
 */
class CreateFormComposer
{
    ...
    public function compose(View $view)
    {
        ...
        $inputTypes = [];
        $values = Lang::get('values.user_custom_items.input_type_date');
        foreach (config("consts.user_custom_items.INPUT_TYPE_DATE_LIST") as $k => $v) {
