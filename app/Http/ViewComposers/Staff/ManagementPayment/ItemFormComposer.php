...
class ItemFormComposer
{
    ...
    public function compose(View $view)
    {
        ...
        $searchParam = [];// 検索パラメータ
        foreach (array_merge(['status','reserve_number','supplier_name','item_name','item_code','last_manager_id','payment_date_from','payment_date_to', 'search_option_open'], $userCustomItems->pluck('key')->all()) as $p) { // 基本パラメータ + カスタム項目パラメータ
