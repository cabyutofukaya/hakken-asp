<?php
namespace App\Http\ViewComposers\Staff\ReserveInvoice;
...
class PdfComposer
{
    ...
    public function compose(View $view)
    {
        ...
        foreach ([
            ...
            $value[$f] = $reserveInvoice->{$f};
        }

        // 参加者情報
        $participantInfo = $this->reserveService->getParticipants($reserve->id, true); // 参加者一覧（取消者を含む。削除済は取得しない）
        // 参加者情報
        $participants = []; // 参加者リスト
