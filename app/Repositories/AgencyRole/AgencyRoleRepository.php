            ...
            ['agency_id' => $agencyId, 'name' => 'システム管理者', 'description' => '全ての権限を持つ管理者アカウント', 'master' => true,
                'authority' =>
                    [
                        ...
                        'account_payable_details|account_payable_items|account_payable_reserves|account_payables|agency_bundle_deposits|agency_deposits|agency_withdrawals|reserve_bundle_invoices|reserve_bundle_receipts|reserve_invoices|reserve_receipts|v_reserve_invoices' => array_values(config("consts.agency_roles.ACTIONS_LIST")),
