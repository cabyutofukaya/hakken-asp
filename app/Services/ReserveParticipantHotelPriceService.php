...
class ReserveParticipantHotelPriceService implements ReserveParticipantPriceInterface
{
    ...
    {
        return $this->reserveParticipantHotelPriceRepository->whereExists(['reserve_itinerary_id' => $reserveItineraryId], $getDeleted);
    }
    ...
    {
        return $this->reserveParticipantHotelPriceRepository->updateIds(['cancel_charge' => $cancelCharge, 'cancel_charge_net' => $cancelChargeNet, 'cancel_charge_profit' => $cancelChargeProfit, 'is_cancel' => $isCancel], $ids);
    }
    ...
    {
        $targetRows = $this->reserveParticipantHotelPriceRepository->getWhere(['reserve_itinerary_id' => $reserveItineraryId], [], ['id']);
