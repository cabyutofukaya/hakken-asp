...
class ReserveParticipantOptionPriceService implements ReserveParticipantPriceInterface
{
    ...
    public function isExistsDataByParticipantId(int $participantId, ?bool $isValid = null, bool $getDeleted = false) : bool
    {
        ...
        return $this->reserveParticipantOptionPriceRepository->whereExists($param, $getDeleted);
    }
    ...
    {
        return $this->reserveParticipantOptionPriceRepository->updateIds(['is_alive_cancel' => true], $ids);
    }
