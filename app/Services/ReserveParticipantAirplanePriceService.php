...
class ReserveParticipantAirplanePriceService implements ReserveParticipantPriceInterface
{
    ...
    {
        return $this->reserveParticipantAirplanePriceRepository->whereExists(['reserve_id' => $reserveId], $getDeleted);
    }
    ...
    {
        return $this->reserveParticipantAirplanePriceRepository->updateIds(['cancel_charge' => $cancelCharge, 'cancel_charge_net' => $cancelChargeNet, 'is_cancel' => $isCancel], $ids);
    }
